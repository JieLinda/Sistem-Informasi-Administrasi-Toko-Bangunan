    ...
    <div class="w-4/5">
     <main class="p-6">
      <div class="bg-white p-6 rounded-lg shadow-lg">
       ...
       <a class="bg-purple-600 text-white px-4 py-2 rounded-lg" href="add_supplier.php">Add Supplier</a>
        
       <form action="" method="post">
        <div class="flex items-center">
         <input name="supp" class="border border-gray-300 rounded-lg px-3 py-2" autofocus placeholder="Cari nama supplier.." type="text" id="keyword">
        </div>
        </form>
       </div>
