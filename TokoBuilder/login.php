        ...
        <div class="w-full max-w-md">
            <main class="p-6">
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <h2 class="text-2xl font-semibold text-purple-600 mb-4 text-center">Login</h2>
                    <form action="authen.php" method="POST">
                        ...
                        <div class="mb-4">
                            <button type="submit" class="bg-purple-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-purple-700 w-full">Login</button>
                        </div>
                        <div class="text-center">
                            <p class="text-gray-600">Create an account</p>
                            <a href="signup.php" class="text-purple-600 font-bold hover:underline">Sign Up</a>
                        </div>
                    </form>
                </div>
            </main>
